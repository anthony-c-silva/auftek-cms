...
export interface ApiMembroTimeMembroTime extends Struct.CollectionTypeSchema {
  collectionName: 'membro_times';
  info: {
    displayName: 'Membro Time';
    pluralName: 'membro-times';
    singularName: 'membro-time';
  };
  options: {
...
export interface ApiPaginaHomePaginaHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    about_descricao1: Schema.Attribute.Text;
    about_descricao2: Schema.Attribute.Text;
    about_titulo: Schema.Attribute.String;
    about_video_url: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hero_imagem1: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    hero_imagem2: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    hero_subtitulo: Schema.Attribute.String;
    hero_tag: Schema.Attribute.String;
    hero_titulo: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::membro-time.membro-time': ApiMembroTimeMembroTime;
